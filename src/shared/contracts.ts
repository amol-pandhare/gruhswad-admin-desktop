...
export const operationsSchema = z.object({ open: z.boolean(), message: z.string(), pickupEnabled: z.boolean(), deliveryEnabled: z.boolean(), preorderWindow: preorderWindowSchema.default({start:"00:00",end:"21:00"}), closurePeriod: closurePeriodSchema.nullable().default(null) });
