...
describe("local data profiles",()=>{
  it("uses fixed production and intensive-testing paths",()=>{const state=profileState("C:\\Users\\test\\AppData\\Roaming","production");expect(state.profiles.map(profile=>profile.databasePath)).toEqual(["C:\\Users\\test\\AppData\\Roaming\\gruhswad-admin-desktop\\gruhswad-admin.db","C:\\Users\\test\\AppData\\Roaming\\gruhswad-admin-desktop-testing\\gruhswad-admin.db"])});
